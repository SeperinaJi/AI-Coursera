...
print('total validation horse images: ', len(validation_human_names))

#display images 4x4 layout
...
for i , imag_path in enumerate(next_horse_pix + next_human_pix):
...
#flow data from director using ImageGenerator
